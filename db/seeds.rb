...
posts = Post.create!([
                       { user: users[0], title: "Alice's first post", body: "Content of Alice's first post", category: categories[0] },
                       { user: users[0], title: "Alice's guide to Ruby", body: "Tips and tricks about Ruby programming!", category: categories[2] },
                       { user: users[1], title: "Bob's fitness routine", body: "How to stay fit while working full-time.", category: categories[3] },
                       { user: users[2], title: "Charlie's cooking tips", body: "How to cook the perfect pasta.", category: categories[4] },
                       { user: users[3], title: "Dave's technology review", body: "Analyzing the latest gadgets of 2023.", category: categories[0] },
                       { user: users[4], title: "Ella's healthy lifestyle", body: "How to live a healthy and balanced life.", category: categories[3] },
                       { user: users[5], title: "Frank's favorite books", body: "Top 10 books you must read.", category: categories[2] },
                       { user: users[6], title: "Grace's gardening tips", body: "How to grow your garden the right way.", category: categories[4] },
                       { user: users[7], title: "Hank's meditation guide", body: "Find your inner peace with meditation.", category: categories[3] },
                       { user: users[8], title: "Ivy's lifestyle blog", body: "Secrets to a joyful lifestyle.", category: categories[1] },
                       { user: users[9], title: "Jack's adventures in food", body: "Exploring the world through food.", category: categories[4] },
                       { user: users[10], title: "Karen's coding journey", body: "A beginner's guide to coding.", category: categories[2] },
                       { user: users[11], title: "Luke's admin tips", body: "How to manage your digital life effectively.", category: categories[0] }
                     ])
puts 'Posts created'
...
comments = Comment.create!([
                             ...
                             { post: posts[10], user: users[2], content: 'Food is a magical part of life. Love this, Jack!' },
